...
<head>
    ...
    <script>
        ...
        function checkMonth(se) {
            var month = $('#' + se + 'month').val();
            var year = $('#' + se + 'year').val();
            var days = 31;
    ...
    <div class="contentDiv">
        <form class="form-horizontal" action="setSchedule" method="post">
            ...
            <div class="form-group" onchange="checkDays()">
                <div class="checkbox">
                    <label for="mon" class="col-sm-1"><input type="checkbox"
                                                             id="mon" class="days" name="mon">Mon</label> <label for="tue"
                                                                                                                 class="col-sm-1"><input type="checkbox" id="tue"
                                                                                                                                         class="days" name="tue">Tue</label> <label for="wed"
                                                                                                                                                                                    class="col-sm-1"><input type="checkbox"
                                                                                                                                                                                                            id="wed"
                                                                                                                                                                                                            class="days"
                                                                                                                                                                                                            name="wed">Wed</label>
                    <label for="thu"
                           class="col-sm-1"><input type="checkbox" id="thu"
                                                   class="days" name="thu">Thu</label> <label for="fri"
                                                                                              class="col-sm-1"><input type="checkbox" id="fri"
                                                                                                                      class="days" name="fri">Fri</label> <label for="sat"
                                                                                                                                                                 class="col-sm-1"><input type="checkbox" id="sat"
                                                                                                                                                                                         class="days" name="sat">Sat</label>
                    <label for="sun"
                           class="col-sm-1"><input type="checkbox" id="sun"
                                                   class="days" name="sun">Sun</label> <label for="allDays"
                                                                                              class="col-sm-2"><input type="checkbox" id="allDays"
                                                                                                                      name="allDays" checked>All Days</label>
                </div>
            </div>
            <br>
