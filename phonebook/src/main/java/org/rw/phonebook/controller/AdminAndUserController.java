...
public class AdminAndUserController {
    ...
    public String updateUserInfo(HttpSession session, @RequestParam("uid") long uid, @RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("phoneNumber") String phoneNumber, @RequestParam("email") String email, @RequestParam("address") String address) {
        if (isAdminLoggedIn(session)) {
    ...
    public String setSchedule(HttpSession session, @RequestParam("uid") long uid, @RequestParam("syear") int syear, @RequestParam("smonth") int smonth, @RequestParam("sday") int sday, @RequestParam("eyear") int eyear, @RequestParam("emonth") int emonth, @RequestParam("eday") int eday, @RequestParam("stime") String stime, @RequestParam("etime") String etime, @RequestParam("hrs") int hrs, @RequestParam("mins") int mins, @RequestParam(value = "mon", required = false) Object mon, @RequestParam(value = "tue", required = false) Object tue, @RequestParam(value = "wed", required = false) Object wed, @RequestParam(value = "thu", required = false) Object thu, @RequestParam(value = "fri", required = false) Object fri, @RequestParam(value = "sat", required = false) Object sat, @RequestParam(value = "sun", required = false) Object sun) {
        if (isAdminLoggedIn(session)) {
            String selectedDays = "";
            if (sun != null) {
                selectedDays += "1";
            ...
            if (EmailScheduleManager.findSchedule(admin, user) != null) {
                ...
                try {
                    ...
                    EmailScheduleManager.createSchedule(new EmailSchedule(admin, user));
                } catch (Exception e) {
                    session.setAttribute(ERROR_MSG_ATTRIBUTE, e.getMessage());
                    return REDIRECT_ERROR;
                }
