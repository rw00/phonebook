...
public class EmailScheduler {
    ...
    public static void setSchedule(int sday, int smon, int syr, String stime, int eday, int emon, int eyr, String etime, int minutes, String days, long adminId, long uid) throws SchedulerException {
        ...
        Trigger trig = TriggerBuilder.newTrigger()
                                     .forJob(job)
                                     .withIdentity(TriggerKey.triggerKey(adminId + "_" + uid))
                                     .startAt(scal.getTime())
                                     .withSchedule(DailyTimeIntervalScheduleBuilder.dailyTimeIntervalSchedule()
                                                                                   .onDaysOfTheWeek(selectedDays)
                                                                                   .startingDailyAt(TimeOfDay.hourAndMinuteOfDay(sHr, sMin))
                                                                                   .endingDailyAt(TimeOfDay.hourAndMinuteOfDay(eHr, eMin))
